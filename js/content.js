...
const CHAPTERS = [
  {
    ...
    "sections": [
      ...
      {
        "title": "Think Like an Institutional Trader",
    ...
    "quiz": [
      {
        "question": "What primarily drives long-term currency price trends?",
        "options": [
        ...
        "correct": 1,
        "explanation": "Long-term currency trends are driven by macroeconomic fundamentals — interest rates, economic growth, inflation, and trade flows."
      },
      {
        "question": "What is 'fair value' in fundamental analysis?",
        "options": [
          "The lowest price ever traded",
          "The price based on all known economic factors",
          "The price set by central banks",
          "The average of the last 50 candlesticks"
        ],
        "correct": 1,
        "explanation": "Fair value is the theoretical price based on all known economic factors."
      },
      {
        "question": "In the Currency as Stock analogy, what do interest rates represent?",
        "options": [
          "The stock price",
          "The company's debt",
          "A dividend paid for holding the currency",
          "Market volatility"
        ],
        "correct": 2,
        "explanation": "Interest rates work like dividends — they reward you for holding a currency."
      }
    ]
  },
  {
    "id": 2,
    "title": "Reading Economic Data Like a Pro",
    "icon": "📊",
    ...
    "sections": [
      {
        "title": "The Three-Layer Framework",
      ...
      {
        "title": "Why Context Determines Whether Data Matters",
    ...
    "quiz": [
      {
        "question": "Employment data: +150K jobs. Expectations: +200K. What happens?",
        "options": [
          "Rises — job growth is positive",
          "Falls — data missed expectations",
          "Nothing — market ignores employment",
          "Depends on time of day"
        ],
        "correct": 1,
        "explanation": "Even though positive, it missed expectations. Markets trade delta vs. expectations."
      },
      {
        "question": "In the Three-Layer Framework, which layers usually matter most?",
        "options": [
          "Absolute Value",
          "Delta (% Change)",
          "Trend (6-12 months)",
          "Delta and Trend usually matter more"
        ],
        "correct": 3,
        "explanation": "Delta (rate of change) and trend are typically more important than absolute value."
      },
      {
        "question": "'Buy the Rumor, Sell the Fact' means:",
        "options": [
          "Always buy on news releases",
          "Prices often rise in anticipation and fall when confirmed",
          "Rumors are more reliable than facts",
          "Only trade confirmed news"
        ],
        "correct": 1,
        "explanation": "Markets price in anticipated events beforehand. When confirmed, early buyers take profits."
      }
    ]
  },
  {
    "id": 3,
    "title": "The Business Cycle — Your North Star",
    "icon": "🔄",
    ...
    "sections": [
      {
        "title": "Why the Business Cycle Is the Foundation",
      ...
      {
        "title": "Case Study: 2015 USD/CAD Divergence",
    ...
    "quiz": [
      {
        "question": "During late expansion, which data does the market focus on?",
        "options": [
          "Unemployment",
          "Inflation (CPI)",
          "Retail sales",
        ...
        "correct": 1,
        "explanation": "During late expansion, unemployment is low so nobody cares. The market obsesses over CPI and when the central bank will hike."
      },
      {
        "question": "A recession is formally defined as:",
        "options": [
          "One quarter of slow growth",
          "Two consecutive quarters of negative GDP growth",
          "Rising unemployment for 6 months",
          "A stock market crash >20%"
        ],
        "correct": 1,
        "explanation": "Two consecutive quarters of negative GDP growth."
      },
      {
        "question": "In 2015, why did USD/CAD rise sharply?",
        "options": [
          "Both banks cutting rates",
          "Fed hiking while BoC cutting — divergence",
          "Oil prices rising",
          "Canada had higher GDP"
        ],
        "correct": 1,
        "explanation": "The Fed was moving toward hikes (USD strength) while the BoC was cutting (CAD weakness). Classic divergence."
      },
      {
        "question": "What should you ask BEFORE trading any economic release?",
        "options": [
          "What time does market close?",
          "Does the market currently CARE about this data?",
          "How many pips last time?",
          "What does my indicator say?"
        ],
        "correct": 1,
        "explanation": "The market's focus changes with the business cycle."
      }
    ]
  },
  {
    "id": 4,
    "title": "Inflation — The Silent Force",
    "icon": "🔥",
    ...
    "sections": [
      ...
      {
        "title": "Real vs. Nominal Rates — The Fisher Equation",
      ...
      {
        "title": "How Central Banks Respond to Inflation",
    ...
    "quiz": [
      {
        "question": "What is 'Core CPI' and why is it preferred?",
        "options": [
          "Total inflation — full picture",
          "CPI excluding food and energy — more stable",
          "Core industries only",
          "CPI adjusted for GDP"
        ],
        "correct": 1,
        "explanation": "Core CPI strips out volatile food and energy. More stable and predictive."
      },
      {
        "question": "5% interest rate, 6% inflation. Real rate?",
        "options": [
          "+11%",
          "+1%",
          "-1%",
        ...
        "correct": 2,
        "explanation": "Fisher Equation: 5% − 6% = -1%. Investors lose purchasing power."
      },
      {
        ...
        "options": [
          ...
          "Falling prices + rising GDP",
          "Moderate everything"
        ],
        "correct": 1,
        "explanation": "High inflation + high unemployment. Nearly impossible to fix."
      }
    ]
  },
  {
    "id": 5,
    "title": "Employment & The Labor Market",
    "icon": "👷",
    ...
    "sections": [
      ...
      {
        "title": "Why Employment Is Political",
    ...
    "quiz": [
      {
        ...
        "correct": 1,
        "explanation": "First Friday — timeliness and scope make it highest-impact regular US data."
      },
      {
        "question": "Why might unemployment rate understate true unemployment?",
        "options": [
          "Includes children",
          "Excludes discouraged workers who stopped looking",
          "Only counts full-time",
          "Calculated yearly"
        ],
        "correct": 1,
        "explanation": "Discouraged workers are excluded, making the rate appear lower."
      },
      {
        "question": "What NFP component matters most in high-inflation environments?",
        "options": [
          "Total jobs",
        ...
        "correct": 1,
        "explanation": "Average Hourly Earnings is a proxy for wage-driven inflation."
      }
    ]
  },
  {
    "id": 6,
    "title": "GDP — Measuring Economic Health",
    "icon": "📈",
    ...
    "sections": [
      ...
      {
        "title": "GDP Limitations &amp; Release Schedule",
    ...
    "quiz": [
      {
        ...
        "options": [
          "Nominal includes gov spending, Real doesn't",
          "Nominal includes inflation effects, Real removes them",
          "Real is always higher",
          "No practical difference"
        ],
        "correct": 1,
        "explanation": "Nominal uses current prices, Real uses constant base-year prices."
      },
      {
        "question": "Largest component of US GDP?",
        "options": [
        ...
        "correct": 1,
        "explanation": "Consumer spending is ~70% of US GDP."
      },
      {
        "question": "Which GDP release moves markets most?",
        "options": [
          "Preliminary",
          "Final",
          "Advance",
        ...
        "correct": 2,
        "explanation": "Advance GDP — it comes first. Final GDP is often ignored."
      }
    ]
  },
  {
    ...
    "sections": [
      {
        "title": "Trade Surplus vs. Deficit",
    ...
    "quiz": [
      {
        "question": "Exports $500B, Imports $600B. Trade balance?",
        "options": [
          "$100B surplus",
          "$600B deficit",
          "-$100B deficit",
        ...
        "correct": 2,
        "explanation": "$500B − $600B = -$100B deficit."
      },
      {
        "question": "Why does USD stay strong despite trade deficits?",
        "options": [
          "US doesn't run deficits",
          "Capital account inflows offset the deficit",
          "Government manipulates rates",
          "Deficits always strengthen currency"
        ],
        "correct": 1,
        "explanation": "Capital inflows from foreign investors buying US assets offset the trade deficit."
      }
    ]
  },
  {
    "id": 8,
    "title": "Central Banks — The Market Movers",
    "icon": "🏦",
    ...
    "quiz": [
      {
        "question": "In the Thermostat analogy, 'air conditioning' represents:",
        "options": [
          "Cutting rates",
        ...
        "correct": 1,
        "explanation": "Raising rates cools the overheating economy."
      },
      {
        "question": "QE is generally what for a currency?",
        "options": [
          "Bullish",
          "Bearish — increases money supply",
          "Neutral",
          "Depends on stocks"
        ],
        "correct": 1,
        "explanation": "QE increases money supply and lowers yields — bearish."
      },
      {
        "question": "Why are central bank PIVOTS so important?",
        "options": [
          "Announced on TV",
          "Current stance is priced in; pivots are unexpected change",
          "Affect stocks more",
          "Stance changes daily"
        ],
        "correct": 1,
        "explanation": "The current stance is priced in. Pivots cause repricing."
      },
      {
        "question": "Fed rate at 5%, traders expect a cut. Futures price?",
        "options": [
          "Falls below 95",
          "Stays at 95",
          "Rises above 95",
        ...
        "correct": 2,
        "explanation": "Price = 100 − Expected Rate. If rate expected lower, price rises above 95."
      }
    ]
  },
  {
    "id": 9,
    "title": "Fiscal Policy & Government Action",
    "icon": "🏛️",
    ...
    "sections": [
      ...
      {
        "title": "How Governments Fund Spending",
    ...
    "quiz": [
      {
        "question": "Which is faster: fiscal or monetary policy?",
        "options": [
          "Fiscal",
          "Monetary — rate decisions are immediate",
          "Both equal",
          "Neither is quick"
        ],
        "correct": 1,
        "explanation": "Monetary policy is faster — rate changes take effect immediately."
      },
      {
        "question": "How does higher bond issuance affect currency?",
        "options": [
          "Always positive",
          "Depends: yields attract capital but too much debt signals instability",
          "Always negative",
          "No relationship"
        ],
        "correct": 1,
        "explanation": "Double-edged sword: yields attract capital, but excessive debt can signal instability."
      }
    ]
  },
  {
    "id": 10,
    "title": "Currency Profiles & The Dollar Index",
    "icon": "💱",
    "description": "Deep-dive into major currencies, commodity currencies, the DXY, and the PMI indicator.",
    "sections": [
      {
        "title": "Universal Currency Drivers",
      ...
      {
        "title": "USD — The Reserve Currency",
      ...
      {
        "title": "EUR, JPY &amp; Commodity Currencies",
      ...
      {
        "title": "PMI — The Timely Leading Indicator",
    ...
    "quiz": [
      {
        ...
        "options": [
          "USD always trends up",
          "USD strengthens in risk-off AND strong growth, weakens in moderate conditions",
          "USD and EUR move together",
          "USD always depreciates"
        ],
        "correct": 1,
        "explanation": "USD strengthens at both extremes (panic and strong growth), weakens in the middle."
      },
      {
        "question": "Which currency dominates DXY at 57.6%?",
        "options": [
          "JPY",
          "GBP",
          "EUR",
        ...
        "correct": 2,
        "explanation": "EUR has 57.6% weighting — hence strong EUR/USD-DXY inverse correlation."
      },
      {
        "question": "PMI of 48.5 indicates:",
        "options": [
          "Strong expansion",
        ...
        "correct": 1,
        "explanation": "Below 50 = contraction."
      }
    ]
  },
  {
    "id": 11,
    "title": "Risk Sentiment & Market Psychology",
    "icon": "🎭",
    ...
    "quiz": [
      {
        "question": "In Risk-Off, which assets strengthen?",
        "options": [
          "AUD, NZD, stocks",
          "JPY, CHF, Gold, Treasuries",
          "All commodities",
          "Everything falls equally"
        ],
        "correct": 1,
        "explanation": "Safety assets: JPY, CHF, Gold, US Treasuries."
      },
      {
        "question": "Main risk of a carry trade?",
        "options": [
          "High interest payments",
          "Exchange rate volatility — funding currency can surge",
          "Illegal in most countries",
          "Transaction fees"
        ],
        "correct": 1,
        "explanation": "If the funding currency strengthens rapidly, it wipes out months of carry gains."
      },
      {
        "question": "Most important COT report group for forex?",
        "options": [
          "Commercials",
        ...
        "correct": 1,
        "explanation": "Large Speculators drive trends. Extreme positions signal potential reversals."
      },
      {
        "question": "Why is AUD/JPY a 'risk barometer'?",
        "options": [
          "Most traded pair",
          "Pairs high-yield risk currency with safe haven",
          "Same economy",
          "Lowest spread"
        ],
        "correct": 1,
        "explanation": "AUD (risk) + JPY (safe haven) = mirrors global risk sentiment."
      }
    ]
  },
  {
    ...
    "sections": [
      ...
      {
        "title": "Supply, Demand &amp; Exchange Rates",
      ...
      {
        "title": "The Complete FA Checklist",
    ...
    "quiz": [
      {
        "question": "S&P 500 making highs + oil rising. Dominant theme?",
        "options": [
          "Risk-Off",
          "Risk-On — buy commodity currencies",
          "Stagflation",
          "No clear theme"
        ],
        "correct": 1,
        "explanation": "Rising equities and oil = Risk-On. Buy commodity currencies, sell safe havens."
      },
      {
        "question": "Leading vs. lagging indicators?",
        "options": [
          "Leading are more accurate",
          "Leading predicts future; lagging confirms past",
          "Lagging move first",
          "No practical difference"
        ],
        "correct": 1,
        "explanation": "Leading predicts (PMI, claims). Lagging confirms (unemployment, CPI)."
      },
      {
        "question": "First thing to check before trading any pair?",
        "options": [
          "Chart patterns",
          "Business cycle phase for each country",
          "Account balance",
          "Social media"
        ],
        "correct": 1,
        "explanation": "Business cycle is the foundation of all FA analysis."
      },
      {
        "question": "'FA provides the wind, TA points your sail' means:",
        "options": [
          "FA and TA are separate",
          "FA tells WHAT/WHY; TA tells WHEN/WHERE",
          "TA is more important",
          "FA is only for long-term"
        ],
        "correct": 1,
        "explanation": "FA gives direction (thesis); TA gives timing (signal). Best when combined."
      }
    ]
  }
];
...
const BADGES = [
  ...
  },
  {
    ...
    "name": "Data Decoder",
    "icon": "📊",
    "description": "Completed Chapter 2 quiz",
    "type": "chapter"
  },
  {
    "id": "ch3",
    ...
    "icon": "🔄",
    "description": "Completed Chapter 3 quiz",
    "type": "chapter"
  },
  {
    "id": "ch4",
    ...
    "icon": "🔥",
    "description": "Completed Chapter 4 quiz",
    "type": "chapter"
  },
  {
    "id": "ch5",
    ...
    "icon": "👷",
    "description": "Completed Chapter 5 quiz",
    "type": "chapter"
  },
  {
    "id": "ch6",
    "name": "GDP Guru",
    "icon": "📈",
    "description": "Completed Chapter 6 quiz",
    "type": "chapter"
  },
  {
    "id": "ch7",
    "name": "Trade Flow Tracker",
    "icon": "⚖️",
    "description": "Completed Chapter 7 quiz",
    "type": "chapter"
  },
  {
    "id": "ch8",
    "name": "Central Bank Decoder",
    "icon": "🏦",
    "description": "Completed Chapter 8 quiz",
    "type": "chapter"
  },
  {
    "id": "ch9",
    "name": "Fiscal Policy Pro",
    "icon": "🏛️",
    "description": "Completed Chapter 9 quiz",
    "type": "chapter"
  },
  {
    "id": "ch10",
    ...
    "icon": "💱",
    "description": "Completed Chapter 10 quiz",
    "type": "chapter"
  },
  {
    "id": "ch11",
    ...
    "icon": "🎭",
    "description": "Completed Chapter 11 quiz",
    "type": "chapter"
  },
  {
    "id": "ch12",
    "name": "FA Strategist",
    "icon": "🎯",
    "description": "Completed Chapter 12 quiz",
    "type": "chapter"
  },
  {
    "id": "perfect_score",
  ...
  },
  {
    ...
    "name": "Halfway Hero",
    "icon": "⚡",
    "description": "Complete 6 chapters",
    "type": "special"
  },
  {
    "id": "completionist",
